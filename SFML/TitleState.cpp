...
TitleState::TitleState(GEX::StateStack & stack, State::Context context)
	: State(stack, context)
	, text_()
	, showText_(true)
	, textEffectTime_(sf::Time::Zero)
{
	backgroundSpite_.setTexture(context.textures->get(GEX::TextureID::TitleScreen));
